                ...
                <Card color="transparent" shadow={false}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                        ...
                        <div className="flex items-center pt-4 space-x-1">
                            <div className="flex-1 h-px sm:w-16 bg-blue-gray-200"></div>
                            <p className="px-3 text-sm dark:text-gray-600">Login with social accounts</p>
                            <div className="flex-1 h-px sm:w-16 bg-blue-gray-200"></div>
                        </div>
                        <div className="flex justify-center space-x-4">
                            <button type="button" onClick={handleGoogleLogin} aria-label="Log in with Google" className="p-3 rounded-sm">
                            ...
                            <button type="button" onClick={handleGithubLogin} aria-label="Log in with GitHub" className="p-3 rounded-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
